...
// Importações corrigidas para o GTM
...
export default function RootLayout({
  ...
  return (
    <html lang="pt-BR" suppressHydrationWarning>
      <head>
        {/* SCRIPT DE PROTEÇÃO CONTRA CÓPIA E SELEÇÃO (INTOCADO) */}
        <Script
            ...
            __html: `
              (function() {
                function disableSelection(e) {
                  if (typeof e.onselectstart !== "undefined") { e.onselectstart = function() { return false; }; } else if (typeof e.style.MozUserSelect !== "undefined") { e.style.MozUserSelect = "none"; } else { e.onmousedown = function() { return false; }; }
                  e.style.cursor = "default";
                }
                disableSelection(document.body);
                document.addEventListener('keydown', function(e) {
                  if (e.ctrlKey || e.metaKey) {
                    switch (e.keyCode) { case 67: case 88: case 65: case 83: case 85: e.preventDefault(); e.stopPropagation(); return false; }
                  }
        ...
        />
        {/* SCRIPT ADICIONAL DE PROTEÇÃO DE IMAGENS (INTOCADO) */}
        <Script
              ...
              (function() {
                document.addEventListener('DOMContentLoaded', function() {
                  ...
                  images.forEach(function(img) {
                    img.setAttribute('draggable', 'false'); img.setAttribute('ondragstart', 'return false'); img.setAttribute('oncontextmenu', 'return false'); img.setAttribute('onselectstart', 'return false'); img.setAttribute('oncopy', 'return false'); img.setAttribute('oncut', 'return false'); img.setAttribute('onpaste', 'return false');
                    img.style.pointerEvents = 'none'; img.style.userSelect = 'none'; img.style.webkitUserSelect = 'none'; img.style.mozUserSelect = 'none'; img.style.msUserSelect = 'none'; img.style.khtmlUserSelect = 'none'; img.style.webkitTouchCallout = 'none'; img.style.webkitTapHighlightColor = 'transparent';
                  ...
                  function addWatermark() {
                    images.forEach(function(img) {
                      ...
                      overlay.style.position = 'absolute'; overlay.style.top = '0'; overlay.style.left = '0'; overlay.style.width = '100%'; overlay.style.height = '100%'; overlay.style.backgroundColor = 'rgba(0,0,0,0.01)'; overlay.style.pointerEvents = 'none'; overlay.style.zIndex = '9999';
                      ...
                      if (img.parentNode) { img.parentNode.insertBefore(wrapper, img); wrapper.appendChild(img); wrapper.appendChild(overlay); }
                    });
                  }
                ...
                document.addEventListener('keyup', function(e) {
                  if (e.keyCode === 44) {
                    ...
                    var overlay = document.createElement('div');
                    overlay.style.position = 'fixed'; overlay.style.top = '0'; overlay.style.left = '0'; overlay.style.width = '100%'; overlay.style.height = '100%'; overlay.style.backgroundColor = 'white'; overlay.style.zIndex = '999999'; overlay.style.pointerEvents = 'none';
      ...
      >
        {/* Componente GTM chamado da forma correta para evitar erros */}
        <Suspense>
